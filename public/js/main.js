...
(function ($) {
 "use strict";
	...
	$('[data-countdown]').each(function() {
	  ...
	  $this.html(event.strftime('<div class="sldr_cnt_box"><span>%-D</span>Дней</div><div class="sldr_cnt_box"><span>%-H</span>Часов</div><div class="sldr_cnt_box"><span>%M</span>Минут</div><div class="sldr_cnt_box"><span>%S</span>Секунд</div>'));
	  });
	});
